...
{
    public partial class addSDS : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LandMarkCounty = table.Column<string>(nullable: true),
                    LandMarkVillage = table.Column<string>(nullable: true),
                    LandMarkName = table.Column<string>(nullable: true),
                    LandMarkCode = table.Column<string>(nullable: true),
                    BuildMarkCounty = table.Column<string>(nullable: true),
                    BuildMarkVillage = table.Column<string>(nullable: true),
                    BuildMarkName = table.Column<string>(nullable: true),
                    BuildMarkCode = table.Column<string>(nullable: true),
                    BuildAddressCounty = table.Column<string>(nullable: true),
                    BuildAddressVillage = table.Column<string>(nullable: true),
                    BuildAddress = table.Column<string>(nullable: true),
                    LandArea = table.Column<double>(nullable: false),
                    BuildingArea = table.Column<double>(nullable: false),
                    LandRightsOwner = table.Column<string>(nullable: true),
                    LandRightsStatusId = table.Column<int>(nullable: true),
                    LandRightsHolding = table.Column<string>(nullable: true),
                    BuildingRightsOwner = table.Column<string>(nullable: true),
                    BuildingRightsStatusId = table.Column<int>(nullable: true),
                    BuildingRightsHolding = table.Column<string>(nullable: true),
                    OtherRights = table.Column<string>(nullable: true),
                    LandUses = table.Column<string>(nullable: true),
                    BuildingCoverageRatio = table.Column<double>(nullable: false),
                    FloorAreaRatio = table.Column<double>(nullable: false),
                    BuildingUsageId = table.Column<int>(nullable: true),
                    BuildingStructureId = table.Column<int>(nullable: true),
                    BuildingFinishDate = table.Column<DateTime>(nullable: false),
                    BuildingUpFloor = table.Column<int>(nullable: false),
                    BuildingDownFloor = table.Column<int>(nullable: false),
                    SurveyFloor = table.Column<int>(nullable: false),
                    InspectionDate = table.Column<DateTime>(nullable: false),
                    ValueOpinionDate = table.Column<DateTime>(nullable: false),
                    AppraisalObjectId = table.Column<int>(nullable: true),
                    AppraisalDescription = table.Column<string>(nullable: true),
                    PriceTypeId = table.Column<int>(nullable: true),
                    EvaluationRightsTypeId = table.Column<int>(nullable: true),
                    AppraisalCondition = table.Column<string>(nullable: true),
                    SurveyorName = table.Column<string>(nullable: true),
                    SurveyDescription = table.Column<string>(nullable: true),
                    TranscriptPath = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildAddressVillage = table.Column<string>(nullable: true),
                    BuildAddress = table.Column<string>(nullable: true),
                    ParkArea = table.Column<double>(nullable: false),
                    ParkTypeId = table.Column<int>(nullable: true),
                    ParkMethodId = table.Column<int>(nullable: true),
                    LandRightsOwner = table.Column<string>(nullable: true),
                    LandRightsStatusId = table.Column<int>(nullable: true),
                    LandRightsHolding = table.Column<string>(nullable: true),
                    BuildingRightsOwner = table.Column<string>(nullable: true),
                    ...
                    BuildingRightsHolding = table.Column<string>(nullable: true),
                    OtherRights = table.Column<string>(nullable: true),
                    AssignMethodId = table.Column<int>(nullable: true),
                    LandUses = table.Column<string>(nullable: true),
                    BuildingCoverageRatio = table.Column<double>(nullable: false),
                    FloorAreaRatio = table.Column<double>(nullable: false),
                    BuildingUsageId = table.Column<int>(nullable: true),
                    ...
                    BuildingDownFloor = table.Column<int>(nullable: false),
                    SurveyFloor = table.Column<int>(nullable: false),
                    ParkWidth = table.Column<double>(nullable: false),
                    ParkHeight = table.Column<double>(nullable: false),
                    AllowSuv = table.Column<bool>(nullable: false),
                    InspectionDate = table.Column<DateTime>(nullable: false),
                    ValueOpinionDate = table.Column<DateTime>(nullable: false),
                    AppraisalObjectId = table.Column<int>(nullable: true),
                    AppraisalDescription = table.Column<string>(nullable: true),
